...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> AN_OLD_SONG = ITEMS.register("an_old_song_music_disc", () -> new RecordItem(6, SoundsRegistry.AN_OLD_SONG, new Item.Properties().stacksTo(1), 3600));
