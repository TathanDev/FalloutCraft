...
public class RadiationRemoverBlockEntityRenderer implements BlockEntityRenderer<RadiationRemoverBlockEntity> {

    public RadiationRemoverBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(RadiationRemoverBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
