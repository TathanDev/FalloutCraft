...
public class FalloutConfiguredFeatures {
    ...
    /** Burnt Oak Tree */
    public static final RegistryObject<ConfiguredFeature<?, ?>> BURNT_OAK =
            CONFIGURED_FEATURES.register("burnt_oak", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> BURNT_OAK_SPAWN =
            CONFIGURED_FEATURES.register("burnt_oak_spawn", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR,
                    new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(
                            FalloutPlacedFeatures.BURNT_OAK_CHECKED.getHolder().get(),
                            0.5F)), FalloutPlacedFeatures.BURNT_OAK_CHECKED.getHolder().get())));
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> RADIATED_WATER_LAKE_ASH = CONFIGURED_FEATURES.register("radiared_water_lake_ash",
            () -> new ConfiguredFeature<>(Feature.LAKE,
                    new LakeFeature.Configuration(BlockStateProvider.simple(BlocksRegistry.RADIATED_WATER_BLOCK.get().defaultBlockState()), BlockStateProvider.simple(BlocksRegistry.ASH_BLOCK.get().defaultBlockState()))));
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> ASH_TOP_LAYER = CONFIGURED_FEATURES.register("ash_top_layer",
            () -> new ConfiguredFeature<>(FeatureRegistry.ASH_TOP_LAYER.get(), FeatureConfiguration.NONE));
