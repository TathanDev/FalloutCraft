package fr.tathan.falloutcraft.client.gui.nuka_cola_machine.renderer;
    ...
    public List<Component> getTooltip(FluidStack fluidStack) {
        ...
        try {
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = Component.translatable("falloutcraft.nuka_cola_machine.tooltip.liquid.amount.capacity", nf.format(milliBuckets), nf.format(capacity));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = Component.translatable("falloutcraft.nuka_cola_machine.tooltip.liquid.amount", nf.format(milliBuckets));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
